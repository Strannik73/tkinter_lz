...
# расположение
    ...
    def check_sudoku(self):
        ...
        for row in all_values:
            print(row)
        result = logic_sudocu(all_values)
        if result == "v":
...
def generate_zadacha():
    grid = gener_grid()
    cells_to_remove = random.sample(range(81), 50)
